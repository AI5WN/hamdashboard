...
| Night Shift | `pacu_night.js` | Follow-the-sun world cams for the 2030–0700 crew (3×3): Venice, Abbey Road, Temple Bar, Prague, Tokyo Shibuya Crossing (right-click for Sydney Harbour / Hong Kong), Etosha/Namib waterholes, Vegas Strip, Times Square. Picks the currently-lit set (daylight vs city-lights/floodlit) from Oklahoma time and reloads hourly; force with `&band=day` or `&band=night` |
